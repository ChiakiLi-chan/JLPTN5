...
/* ---------- Flashcard ---------- */
.flash-card { background: transparent; border: none; padding: 0; display: block; width: 100%; flex: 1; min-height: 360px; perspective: 1200px; margin-bottom: 14px; position: relative; }
.flash-card-inner { position: absolute; inset: 0; transform-style: preserve-3d; transition: transform 0.4s cubic-bezier(.3,.8,.4,1); }
...
.flash-romaji { font-family: 'Zen Kaku Gothic New', sans-serif; font-size: 42px; font-weight: 800; color: var(--ink); letter-spacing: 0.02em; word-break: break-word; }
